    ...
    <div class="container">
                    ...
                    if (isset($_SESSION['uid'])) {
                        ...
                        if ($result->num_rows > 0)
                        {
                            ...
                            if ($_SESSION['mob.no'] == 0){
                                echo "<div class=\"alert\"><a href=\"rider-settings.php\">Please enter a valid mobile number in settings</a></div>"; 
                            }
                        }
                    }
                ?>
        ...
        <main class= "container2">
            ...
            <div class="bg-white mt-4 flex flex-row">
                <img class="static rounded-[80px] -ml-24 h-[360px]" src="../image/46603.jpg" alt="image not found">
                ...
                <div class="bg-white min-h-7 mt-20 sm:border border-indigo-600 absolute right-0 sm:mr-[200px] md:mr-[300px] lg:mr-[450px] rounded-3xl overflow-visible max-w-1/2 flex flex-col">
                    <div class="m-3">
                        ...
                        <div>
                            ...
                            <button type="submit" name="free" id="free" class="bg-gray-100 mt-2 p-1 w-full drop-shadow-md rounded-xl text-xl font-light">Free</button>
                            </form>
                            <form action="Rider's-home.php" method="post"> 
                                <button type="submit" name="busy" id="busy" class="bg-gray-100 mt-2 p-1 w-full drop-shadow-md rounded-xl text-xl font-light">Busy</button>      
                            </form>
                        </div>     
                    </div>
                </div>
